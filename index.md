...
The msigdbr package provides Molecular Signatures Database (MSigDB) gene
sets in a tidy R data frame.
...
You can convert the original human genes to their orthologs in other
...
You can retrieve gene sets from a specific collection, such as the
Hallmark gene sets.
