...
test_that("species", {
  ...
  expect_equal(n_distinct(m_hs_hs$gs_collection), 10)
  ...
  # Collection sizes
  m_colls <- distinct(m_hs_hs, gs_collection, gs_id)
  m_colls <- count(m_colls, gs_collection)
  m_colls <- split(m_colls$n, m_colls$gs_collection)
  expect_gt(m_colls$C1, 300)
  mc_colls <- msigdbr_collections()
  mc_colls <- split(mc_colls$n, mc_colls$gs_collection)
  expect_identical(names(m_colls), names(mc_colls))
  expect_identical(m_colls$C1, mc_colls$C1)
  expect_identical(m_colls$C6, mc_colls$C6)
  expect_identical(m_colls$C8, mc_colls$C8)
  expect_identical(m_colls$C9, mc_colls$C9)
  expect_identical(m_colls$H, mc_colls$H)
  # Gene set sizes
