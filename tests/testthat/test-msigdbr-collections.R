...
test_that("msigdbr_collections()", {
  ...
  expect_match(collections$gs_subcat, "GO:BP", fixed = TRUE, all = FALSE)
  expect_match(collections$gs_subcat, "HPO", fixed = TRUE, all = FALSE)
})
