...
This outlines how to propose a change to msigdbr. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("igordot/msigdbr", fork = TRUE)`.
...
Please note that the msigdbr project is released with a [Contributor
Code of Conduct](https://igordot.github.io/msigdbr/CODE_OF_CONDUCT.md).
